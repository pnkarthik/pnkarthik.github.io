        ...
        <div className="row">
          ...
          <div className="col-md-12">
            ...
            <p className="contentFontSize">
              <p className="m-0">
                I am an incoming Assistant Professor in the <a href="https://ai.iith.ac.in/" target="_blank" rel="noopener noreferrer">Department of Artificial Intelligence</a> at the <a href="https://iith.ac.in/" target="_blank" rel="noopener noreferrer">Indian Institute of Technology, Hyderabad</a> (IIT Hyderabad). Prior to this, I was a Research Fellow in the <a href="https://ids.nus.edu.sg/" target="_blank" rel="noopener noreferrer">Institute of Data Science</a> at the <a href="https://www.nus.edu.sg/" target="_blank" rel="noopener noreferrer">National University of Singapore</a> (NUS),
