          ...
          <div className="col-md-12">
            ...
            <p className="contentFontSize">
              <p className="m-0">
                ...
                Much earlier to joining for the dual degree programme, I worked as a Project Assistant in Prof. <a href="https://ece.iisc.ac.in/~cmurthy/doku.php?id=home" target="_blank" rel="noopener noreferrer">Chandra R. Murthy</a>'s lab at IISc.
                I hold a Bachelor of Engineering degree from <a href="https://rvce.edu.in/" target="_blank" rel="noopener noreferrer">R V College of Engineering</a>.
              </p>
            </p>
          </div>
        </div>
