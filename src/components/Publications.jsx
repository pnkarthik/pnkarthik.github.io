...
import Publication from "./PublicationsComponent";
        ...
        <div className="col-md-10">
          ...
          <ul>
            <li>
              ...
              <a href="https://karthikpn.com/wp-content/uploads/2021/11/main.pdf" target="_blank" rel="noopener noreferrer" className="badgePadding"><span className="badge rounded-pill" style={{ backgroundColor: getBadgeColor("paper") }}>pdf</span></a>
