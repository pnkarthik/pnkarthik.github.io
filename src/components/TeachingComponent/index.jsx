                    ...
                    return (
                      <li key={index1}>
                        ...
                        {note.badgesData && note.badgesData.map((badge, index2) => {
                            return (
                              <a key={index2} href={badge.link} target="_blank" rel="noopener noreferrer" className="badgePadding"><span className="badge" style={{ backgroundColor: getBadgeColor(index2) }}>{badge.badgeDisplayName}</span></a>
                            )
                          })
                        }
                      </li>
