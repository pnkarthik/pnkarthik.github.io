...
const TeachingComponent = () => {
  ...
  return (
    <>
      <div className="col">
      From the earliest days of my life, teaching has been a calling that I could not ignore. Whether I was explaining hard mathematical concepts to my sibling or watching in awe as my own teachers brought complex ideas to life in classroom, I knew that I wanted to be a part of this transformative process called teaching. In my experience, effective teaching is about more than just delivering information. To truly inspire and motivate students, it is essential to stay up‑to‑date with the latest developments in one’s field and to approach teaching as a form of ongoing research.
      </div>
      <div className="col">
        <p></p>
